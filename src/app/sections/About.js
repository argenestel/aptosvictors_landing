      ...
      <div className='p-4 my-20 w-full h-fit' id='about'>
        <div className='flex flex-col md:flex-row'>
          <div className='md:w-1/2 w-full font-lato flex flex-col justify-center'>
            ...
            <p className='text-base font-light my-2'>But the benefits don't stop there. As you progress through the game, your NFT Victor will level up alongside you, evolving and growing in strength, ensuring that your gaming experience remains fresh, challenging, and utterly captivating.</p>
          </div>
