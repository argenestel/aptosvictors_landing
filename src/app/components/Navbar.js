...
const Navbar = () => {
  ...
  return (
    <>
  <nav className="flex justify-between items-center py-6 px-8 bg-gray-800 relative w-full">
    <div className="text-xl font-bold font-lato">AptosVictors</div>
    <div className="md:flex md:hidden cursor-pointer" onClick={()=>{setVis(!vis)}}><GiHamburgerMenu size={20} color="white"/></div>
    ...
    {vis && <div className="absolute top-[100%] z-10 bg-gray-800 left-0 flex flex-col w-full items-center ">
